...
async function deploy() {
  ...
  const mnemonic = "cruise broccoli town rocket puzzle sorry pool urban empower figure special virus sauce salmon wash bottom swap render human danger brother danger moral rib"; // your 24 secret words (replace ... with the rest of the words)
